...
os.environ["TORCH_HOME"] = "/scratch/krishnansh/.torch"
...
if __name__ == "__main__":
    ...
    train_dataset = Dataset(cfg.gt_root, cfg, mask_file=cfg.mask_root)
    iterator_train = data.DataLoader(
        train_dataset, batch_size=cfg.batchSize, shuffle=True, num_workers=cfg.num_workers
    )
    val_dataset = Dataset(cfg.val_root, cfg, mask_file=cfg.val_mask_root)
    iterator_val = data.DataLoader(
        val_dataset, batch_size=cfg.batchSize, shuffle=True, num_workers=cfg.num_workers
    )
