...
class BaseConfig:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--gt_root",
            type=str,
            default="/scratch/krishnansh/Data/lhq_256",
        ...
        parser.add_argument(
            "--num_workers", type=int, default=40, help="numbers of the core of CPU"
        )
        parser.add_argument(
            "--name",
            type=str,
            default="PDGAN-stitchtrain/",
        ...
        parser.add_argument(
            "--pre_ckpt_PConv_EN_dir", default="checkpoints/PConv-Stitchtrain/22_net_EN.pth", type=str, help="max image size"
        )
        parser.add_argument(
            "--pre_ckpt_PConv_DE_dir", default="checkpoints/PConv-Stitchtrain/22_net_DE.pth", type=str, help="max image size"
        )
        ...
        parser.add_argument(
            ...
            type=int,
            default=10000,
            help="the number of training data images",
        )
        parser.add_argument(
            "--val_data_size",
            type=int,
            default=1000,
            help="the number of validation data images",
        )
        parser.add_argument(
            "--test_data_size",
            type=int,
            default=1000,
            help="the number of test data images",
        )
        ...
        parser.add_argument('--netG', default='../Context_encoder/model/lhq_256/normal_stitch/run_2/netG_final.pth', help="path to netG (to continue training)")
        parser.add_argument('--netD', default='../Context_encoder/model/lhq_256/normal_stitch/run_2/netD_final.pth', help="path to netD (to continue training)")

        parser.add_argument('--ngpu', type=int, default=1, help='number of GPUs to use')

        parser.add_argument('--masking',type=str,default='stitch',help='random-box | center-box | random-crop | custom | stitch')
        parser.add_argument('--WGAN',action='store_true',help='WGAN training')

        parser.add_argument('--cuda', action='store_true', help='enables cuda')

        parser.add_argument('--prior_net', default="PConv")
